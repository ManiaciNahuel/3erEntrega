...
const { usuarioModel } = require('../../models/product');
...
class ContenedorMg {
    ...
    async connect() {
        try {
            const url = 'mongodb+srv://Nahuel_Maniaci:nahue123@cluster0.qvotb9b.mongodb.net/productos?retryWrites=true&w=majority'
